            ...
            <div class="cluster">
              ...
              <div class="cluster gap-xs">
                ...
                >
                  ...
                  <nd-tooltip tip-position="block-end"
                    >Toggle <span class="badge badge-primary"></span
                  ></nd-tooltip>
                </button>
                <a href="${this.navbar.header.action.url}" class="btn"
                  >${this.navbar.header.action.label}</a
                >
              </div>
            </div>
            <div class="bottombar">
  ...
  render() {
    return html`
      <div class="stack gap-xl ${this.overrides}">
        ${this.renderNavbar()}
        <section
          class="prose auto stack gap-xs justify-center align-${this.config
            .align} grow-1"
        >
