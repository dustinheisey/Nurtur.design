...
<Meta title="Foundations/Sustainability" parameters={{ status: { type: 'stable' } }} />

# Sustainability

Environmental sustainability is a core principle of this design system. It aims to reduce ecological footprint through thoughtful design and development practices.
