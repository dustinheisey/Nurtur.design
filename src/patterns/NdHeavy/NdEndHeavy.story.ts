...
import NdEndHeavy from './NdEndHeavy.vue';

const meta: Meta<typeof NdEndHeavy> = {
  title: 'Regions/NdEndHeavy',
  component: NdEndHeavy,
  tags: ['autodocs']
};
export default meta;

export const Default: StoryObj<typeof NdEndHeavy> = {
  render: args => ({
    components: { NdEndHeavy },
    setup() {
      return { args };
    },
    template: `
      <NdEndHeavy v-bind="args">
